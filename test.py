...
def insert_jobposting(conn, c, strbody, strTitle, dtExpired, dtPosted, strState, strCity, strOnet, strSoc5, strSoc2):
    strSQL ="""INSERT INTO tblJobPosting 
    (body, title, expired, posted, state, city, onet, soc5, soc2) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)""", (strbody, strTitle, dtExpired, dtPosted, strState, strCity, strOnet, strSoc5, strSoc2)
    print (strSQL)
    c.execute(strSQL)
